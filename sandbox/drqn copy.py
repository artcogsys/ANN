...
class DRQN(object):
    ...
    def __init__(self, ninput, noutput, **kwargs):
        ...
        self.nframes = kwargs.get('nframes', 20)
    ...
    def experienceReplay(self):
        ...
        for i in xrange(self.nframes):
            ...
            if (i + 1) % 10 == 0 or (i + 1) == self.nframes:
    ...
    def forward(self, obs, action, reward, obs2, done):
        ...
        for i in xrange(self.nreplay):
            ...
            if not done[i]:
                ...
                #self.reset() # reset when a done has been encountered; how does the model handle multiple trials???
